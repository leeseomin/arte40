...
cd ..
cd s15
parallel gmic {} -fx_jr_deform 0,15,1,10,1,0,0,1,0,50,50 -o ../s16/{} ::: *.*
cd ..
cd s16
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3d_fl_de" "%[filename:new].png" ::: *.*
cd ..
cd s16
parallel gmic {} -fx_jr_deform 0,50,1,30,1,0,0,1,0,50,50 -o ../s17/{} ::: *.*
cd ..
cd s17
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3d_fl_de2" "%[filename:new].png" ::: *.*
cd ..
cd s5
...
cd ..
cd s15
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3a_fl" "%[filename:new].png" ::: *.*
cd ..
cd s15
parallel gmic {} -fx_jr_deform 0,15,1,10,1,0,0,1,0,50,50 -o ../s16/{} ::: *.*
cd ..
cd s16
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3a_fl_de" "%[filename:new].png" ::: *.*
cd ..
cd s16
parallel gmic {} -fx_jr_deform 0,50,1,30,1,0,0,1,0,50,50 -o ../s17/{} ::: *.*
cd ..
cd s17
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3a_fl_de2" "%[filename:new].png" ::: *.*
cd ..
cd s15
for i in *.*
do
gmic $i -fx_custom_deformation "(w+h)/20*cos(y*20/h)","(w+h)/20*sin(x*20/w)",1,1,3 -o ../s16/$i
done
cd ..
cd s16
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3a_flood_cartesian_transform" "%[filename:new].png" ::: *.*
cd ..
cd s5
for i in *.* 
do 
...
cd ..
cd s15
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3c_fl" "%[filename:new].png" ::: *.*
cd ..
cd s15
parallel gmic {} -fx_jr_deform 0,15,1,10,1,0,0,1,0,50,50 -o ../s16/{} ::: *.*
cd ..
cd s16
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3c_fl_de" "%[filename:new].png" ::: *.*
cd ..
cd s16
parallel gmic {} -fx_jr_deform 0,50,1,30,1,0,0,1,0,50,50 -o ../s17/{} ::: *.*
cd ..
cd s17
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3c_fl_de2" "%[filename:new].png" ::: *.*
cd ..
cd s6
for i in *.* 
do 
...
cd ..
cd s15
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3b_fl" "%[filename:new].png" ::: *.*
cd ..
cd s15
parallel gmic {} -fx_jr_deform 0,15,1,10,1,0,0,1,0,50,50 -o ../s16/{} ::: *.*
cd ..
cd s16
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3b_fl_de" "%[filename:new].png" ::: *.*
cd ..
cd s16
parallel gmic {} -fx_jr_deform 0,50,1,30,1,0,0,1,0,50,50 -o ../s17/{} ::: *.*
cd ..
cd s17
parallel convert {}  -set filename:new  ../s25/"%tm3_finger3b_fl_de2" "%[filename:new].png" ::: *.*
